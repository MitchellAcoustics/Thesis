\documentclass[oneside,fontsize=11.5pt,titlepage,chapterprefix=true
]{scrbook}
...
* 1 para short background and overall aim
* 1 para diss structure and overall method
* majority of text (60\% findings)
* Lockdown - amount of decrease, r2 of models, trends of predicted assessments
* This thesis sets up a baseline and requirements for developing useful models
* Based on empirical evidence, a framework has been established, including teh goals and constraints of general predictive models to be used. 'Describe framework'
...
* First para, background what will this work lead to
* 3 Layers:
* Importance for designers. this model will lead to design tools, incl soundscapy
* Importance for policy-makers. Will enable assessment and policy guidelines and mapping
* Impact on general public via outreach, communication, quality of life. Soundscape mapping
* Tools and accessibility impact on future research - SSID protocol, ISD, and soundscapy all as tool for future researchers to make use of.
...
\draft{incorporate into acknowledgement}
...
\include{Parts/CircumplexDiscussionApp.tex}

\include{Parts/OverFAppendix.tex}
