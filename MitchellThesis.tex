\documentclass[oneside,fontsize=12pt,titlepage,chapterprefix=true
]{scrbook}
% \documentclass{book}
...
\usepackage[a4paper,margin=35mm, bindingoffset=0mm, footskip=1cm]{geometry}
...
\paragraph*{}
\textbf{Mitchell, A.}, Aletta, F., \& Kang, J. (2021). How to analyse and represent quantitative soundscape data. \emph{JASA-EL}.
...
\include{Chapters/LockdownModelChapter}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

 \include{Chapters/CircumplexChapter.tex}
