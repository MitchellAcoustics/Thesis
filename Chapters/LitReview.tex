...
\section{Soundscape Studies}
  ...
  \subsection{Demographic differences}
    Several studies have attempted to study the degree to which personal and demographic factors influence a person's soundscape perception. In some conceptions \cite{Kou2020Contexts} % cite: add Erfanian 2020
    ...
    A recent study by Kou, Kwan, and Chai (2020) was successful in making inroads in these under-represented environments by studying the Humboldt Park neighbourhood in Chicago, USA \cite{Kou2020Contexts}. Their study included
    % TODO: Finish summarising results from Kou2020

\section{Existing Predictive Models}

  \cite{Lionello2020Review}

  \subsection{Models based on non-acoustic data sources}
    \cite{Verma2020Predicting}, \cite{Gasco2020Social}
