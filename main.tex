\documentclass[oneside,fontsize=13pt,titlepage]{scrbook}
...
\include{Chapters/ProtocolChapter}

\include{Chapters/WHOChapter}
...
\chapter[Study III: Applied Predictive Soundscape Modelling]{Study III: Applied Predictive Soundscape Modelling: A Case Study Investigating Changes from the COVID-19 Lockdown}
