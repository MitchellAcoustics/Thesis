...
\label{ch:lit}
% \markright{\cref{ch:lit}. Literature Review}
...
To this list, I would add `acoustic comfort' as used in \citet{Yang2005Acoustic} and \citet{Vardaxis2018Reviewa} as a ninth potential descriptor. Similarly, the authors identified a range of potential indicators used to characterise the acoustic environment:
