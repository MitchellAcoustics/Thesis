...
I would suggest that ideally two \glsplural{slm} should be used - one as the standard stationary \gls{slm} running throughout and one to replace the function of the binaural headset, taking short term measurements with audio recording while each participant is completing the survey.
